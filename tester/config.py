...
config = {
    ...
    'input_file': r"tester\testdata\sample.csv",   # Path to input CSV file
    'output_file': r"tester\testdata\test.csv",  # Path to save cleaned output
    'report_file': r"tester\testdata\text_cleaning_report.txt",  # Path to save cleaning report
